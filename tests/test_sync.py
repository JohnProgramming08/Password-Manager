...
@patch("requests.post")
def test_upload_file_valid(mock_post, monkeypatch, email_config):
    ...
    sync = Sync("http:/", vault_path="test")
    assert sync.upload_file("config.json") == 200
    mock_post.assert_called_once()


@patch("requests.post")
def test_upload_file_invalid(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
    fake_response = MagicMock()
...
@patch("requests.post")
def test_push_valid(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
    fake_response = MagicMock()
    fake_response.status_code = 200
    fake_response.return_value = {"ok": True}
...
def test_push_invalid1(monkeypatch, email_config):
...
@patch("requests.post")
def test_push_invalid2(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
    fake_response = MagicMock()
    fake_response.status_code = 404
...
# Downloading a file
@patch("requests.post")
def test_download_file_valid(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
...
@patch("requests.post")
def test_download_file_invalid(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
    fake_response = MagicMock()
    fake_response.status_code = 404
...
@patch("requests.post")
def test_get_file_names_valid(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
...
@patch("requests.post")
def test_get_file_names_invalid(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
    fake_response = MagicMock()
    fake_response.status_code = 404
    fake_response.json.return_value = {}
...
@patch("requests.post")
def test_pull_valid(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
...
def test_pull_invalid1(monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "wrong")
    sync = Sync("http:/", vault_path="test")
...
@patch("requests.post")
def test_pull_invalid2(mock_post, monkeypatch, email_config):
    monkeypatch.setattr("getpass.getpass", lambda _: "test")
